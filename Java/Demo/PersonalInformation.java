...
class PersonalInformation extends Frame{
	
	Button btnClose;
	Panel panelForm;

	Label labelName, labelCourse, labelRollNo, labelCollege,labelCGPA;  // Labels
	
	TextField fieldName, fieldCourse, fieldRollNo, fieldCollege,fieldCGPA;  // TextFields 

	PersonalInformation(String name, String course, String rollNo, String college,String CGPA){
		super("Personal Information");

        // btnA = new Button("A");
		// btnA.setBounds(25, 50, 250, 50);
        ...
        labelCGPA = new Label("CGPA");
        labelCGPA.setBounds(20,110,80,30);
        ...
        // btnB = new Button("B");
		// btnB.setBounds(25, 50, 250, 50);
		// btnB.addActionListener(this);
		// this.add(btnB);

        fieldCGPA = new TextField(CGPA);
        fieldCGPA.setBounds(30,30,100,50);
        fieldCGPA.setEditable(false);
        ...
        panelForm.add(labelCGPA);
        panelForm.add(fieldCGPA);
...
public static void main(String[] args) {
         new PersonalInformation("Avir","B.Tech","46","bhoot college","9.8");
}
}